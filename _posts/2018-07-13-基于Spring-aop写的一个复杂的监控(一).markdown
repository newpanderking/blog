---
layout: post
title:  "基于Spring aop写的一个复杂的监控(二)"
categories: 技术
tags: spring
author: jason
description: 基于spring aop思想做一个切面监控，监控应用方法耗时情况、以及参数数据、调用者数据信息
---


> 背景: 基于spring aop思想配置的一个切面监控，可以参考文章[基于Spring-aop写的一个简单的耗时监控(一)](https://newpanderking.github.io/blog/技术/2018/06/22/基于Spring-aop写的一个简单的耗时监控(一).html)
